...
class Yolomain(nn.Module):
    def __init__(self, anchors_mask, num_classes):
        ...
        self.preHead13 = yolo_head([512, len(anchors_mask[0]) * (5 + num_classes)], 512)
        self.preHead26 = yolo_head([256, len(anchors_mask[1]) * (5 + num_classes)], 512)
    ...
    def forward(self, x):
        ...
        print(up.size())
        out1 = self.preHead26(up)
        out2 = self.preHead13(x)
        return out1, out2
